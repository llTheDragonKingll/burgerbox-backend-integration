...
export default function Cart() {
  ...
  const S = {
    ...
    inner: { maxWidth: "1100px", margin: "0 auto", padding: isMobile ? "24px 16px" : "40px 32px" },
    heading: { fontSize: isMobile ? "36px" : "56px", margin: "0 0 4px", letterSpacing: "2px" },
    ...
    card: {
      ...
      padding: isMobile ? "14px" : "20px", display: "flex", alignItems: "center",
      gap: isMobile ? "10px" : "16px",
    },
    imgBox: {
      width: isMobile ? "60px" : "80px", height: isMobile ? "60px" : "80px",
      borderRadius: "10px", background: "#2a2010", flexShrink: 0,
      display: "flex", alignItems: "center", justifyContent: "center",
      fontSize: "32px", overflow: "hidden",
    },
    itemTitle: { fontFamily: "'Bebas Neue', sans-serif", fontSize: isMobile ? "16px" : "20px", letterSpacing: "1px", margin: "0 0 4px" },
    ...
    qtyBtn: {
      ...
      background: "#2a2010", color: "#fff", cursor: "pointer",
    ...
    removeBtn: { marginLeft: "auto", background: "none", border: "none", color: "#555", cursor: "pointer", fontSize: "18px", padding: "4px" },
    itemPrice: { fontFamily: "'Bebas Neue', sans-serif", fontSize: isMobile ? "16px" : "20px", color: "#f97316", marginLeft: "auto", whiteSpace: "nowrap" },
    summaryCard: {
      background: "#1a1208", border: "1px solid #2a2010", borderRadius: "14px",
      padding: "24px", position: isMobile ? "static" : "sticky", top: "100px",
    },
    ...
    totalRow: { display: "flex", justifyContent: "space-between", borderTop: "1px solid #2a2010", paddingTop: "14px", marginTop: "4px" },
